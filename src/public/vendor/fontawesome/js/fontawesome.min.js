...
!(function () {
    ...
    var gt = ht[x];
    function bt() {
        w.removeEventListener('DOMContentLoaded', bt),
            (yt = 1),
            vt.map((t) => t());
    }
    const vt = [];
        ...
        t = At(
            ...
            (t, e) => {
                ...
                return (
                    'far' !== n || r || (n = 'fas'),
                    'string' == typeof a &&
                        (t.names[a] = { prefix: n, iconName: e }),
                    'number' == typeof a &&
                        (t.unicodes[a.toString(16)] = {
                            prefix: n,
                            iconName: e,
                        }),
                    t
    ...
    function te(t) {
        ...
        if (e)
            return (
                (e = Wt(t, e) || e),
                wt(ee.definitions, t, e) || wt(gt.styles, t, e)
            );
    }
    const ee = new (class {
        constructor() {
    ...
    const ae = {
            ...
            parse: {
                icon: (t) => {
                    ...
                    if (
                        'string' == typeof t &&
                        (-1 < t.indexOf(''.concat(et.cssPrefix, '-')) ||
                            t.match(q))
                    ) {
    ...
    function ie(t) {
        ...
        var { width: m, height: d } = a.found ? a : e,
            ...
            t = [
                et.replacementClass,
                r ? ''.concat(et.cssPrefix, '-').concat(r) : '',
            ]
    ...
    function xe(a, t) {
        ...
        if (0 === a.length) n();
            ...
            et.mutateApproach === F && (t = k.requestAnimationFrame || ye),
                t(() => {
                    var t =
                        (!0 !== et.autoReplaceSvg && ve[et.autoReplaceSvg]) ||
                        ve.replace;
    ...
    function Ee(t) {
        const e =
            'nest' === et.autoReplaceSvg ? Ce(t, { styleParser: !1 }) : Ce(t);
