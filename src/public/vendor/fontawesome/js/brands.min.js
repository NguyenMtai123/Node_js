...
!(function () {
    ...
    var h = c,
        ...
        m =
            ...
            'classic'),
        C = { fak: 'kit', 'fa-kit': 'kit' },
        v = { fakd: 'kit-duotone', 'fa-kit-duotone': 'kit-duotone' },
        s = {
            classic: {
                fa: 'solid',
                fas: 'solid',
    ...
    const o = new Set();
    Object.keys(H[m]).map(o.add.bind(o)),
        Object.keys(H.sharp).map(o.add.bind(o)),
        Object.keys(H['sharp-duotone']).map(o.add.bind(o));
    const i = h || {};
    i[a] || (i[a] = {}),
        i[a].styles || (i[a].styles = {}),
        i[a].hooks || (i[a].hooks = {}),
        i[a].shims || (i[a].shims = []);
    var d = i[a];
    function n(h) {
    ...
    function u(c, l, z) {
        var { skipHooks: h = !1 } =
                2 < arguments.length && void 0 !== z ? z : {},
            z = n(l);
        'function' != typeof d.hooks.addPack || h
            ? (d.styles[c] = { ...(d.styles[c] || {}), ...z })
            : d.hooks.addPack(c, n(l)),
            'fas' === c && u('fa', l);
    }
    var b = {
        monero: [
