    ...
    (l = function () {
        ...
        var r = a,
            ...
            n =
                ...
                'classic'),
            o = { fak: 'kit', 'fa-kit': 'kit' },
            s = { fakd: 'kit-duotone', 'fa-kit-duotone': 'kit-duotone' },
            t = {
                classic: {
                    fa: 'solid',
                    fas: 'solid',
        ...
        const m = new Set();
        Object.keys(i[n]).map(m.add.bind(m)),
            Object.keys(i.sharp).map(m.add.bind(m)),
            Object.keys(i['sharp-duotone']).map(m.add.bind(m));
        const k = r || {};
        k[f] || (k[f] = {}),
            k[f].styles || (k[f].styles = {}),
            k[f].hooks || (k[f].hooks = {}),
            k[f].shims || (k[f].shims = []);
        var w = k[f];
        const y = [
        ...
        return (
            (function (a) {
                ...
                'function' == typeof w.hooks.addShims
                    ? w.hooks.addShims(y)
                    : w.shims.push(...y);
            }),
            y
