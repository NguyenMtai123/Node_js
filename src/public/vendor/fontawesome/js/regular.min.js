...
!(function () {
    ...
    function p(c, l, s) {
        ...
        'function' != typeof g.hooks.addPack || z
            ? (g.styles[c] = { ...(g.styles[c] || {}), ...s })
            : g.hooks.addPack(c, A(l)),
            'fas' === c && p('fa', l);
    }
    var k = {
        'trash-can': [
